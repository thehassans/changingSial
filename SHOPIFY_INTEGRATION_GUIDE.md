...
5.  **Format:** `JSON`.
6.  **URL:** `https://web.buysial.com/api/shopify/webhooks/orders/create`
...
- [ ] Created Webhook for `Order creation` pointing to `https://web.buysial.com/api/shopify/webhooks/orders/create`
